...
//        Hooks
        ...
        txtDescription = findViewById(R.id.edProductDescription);
    ...
    private void uploadProduct() {
        ...
        if (uri != null && !productPrice.isEmpty() && !productName.isEmpty()) {
            ...
            storageReference.putFile(uri)
                    ...
                    .addOnFailureListener(e -> {
                        progressDialog.dismiss();
                        Toast.makeText(AddItemActivity.this, "Failed to upload", Toast.LENGTH_SHORT).show();
                    });
        } else {
            progressDialog.dismiss();
            Toast.makeText(AddItemActivity.this, "One of the fields is empty", Toast.LENGTH_SHORT).show();
        }
    }
}